...
def score_classifications(instances: List[dict], annotations: List[Annotation], docs: Dict[str, List[str]]) -> Dict[str, float]:
    ...
    for ann in annotations:
        ...
        predicted.append(inst['classification'])
...
def main():
    ...
    """)
    parser.add_argument('--iou_thresholds', dest='iou_thresholds', required=False, nargs='+', type=float, default=[0.1], help='''Thresholds for IOU scoring.
